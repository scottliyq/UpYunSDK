...
+ (UpYun *)sharedClient {
    static UpYun *_sharedClient = nil;
...
- (void)upload:(NSDictionary *)dic {
    ...
    //NSURL *url = [NSURL URLWithString:@"http://v0.api.upyun.com"];
    AFUpyunAPIClient *httpClient = [AFUpyunAPIClient sharedClient];
    AFHTTPRequestOperation *newOperation = [httpClient HTTPRequestOperationWithRequest:request 
    ...
    [httpClient enqueueHTTPRequestOperation:newOperation];
